...
function showRSS(RSS)
{
	...
	{
		item_html = "<li>";
		item_html += (RSS.items[i].link == null) ? "" : "<a href=\"" + RSS.items[i].link + " title=\""+RSS.items[i].title+"\" >"+RSS.items[i].title+"</a>";
		item_html += "</li>";
		document.getElementById("feedresults").innerHTML += item_html;
	}
	document.getElementById("feedresults").innerHTML += "";
	//we're done
