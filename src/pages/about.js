...
const AboutPage = () => (
  <Layout>
    ...
    <PageBody subTitle="About" >
      ...
      and Route53 leveraging the Serverless Framework CLI for deployment. Source available on <a href="https://github.com/mbudm/mbudm.com">Github</a>.</p>
      <p>All content © {new Date().getFullYear()} Steve Roberts.</p>
    </PageBody>
  </Layout>
)
